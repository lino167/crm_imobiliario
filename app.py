...
from ui import DashboardFrame, ClientsFrame, PropertiesFrame, InteractionsFrame
...
class App(ctk.CTk):
    ...
    def show_frame(self, frame_to_show):
        for frame in (self.dashboard_frame, self.clients_frame, self.properties_frame, self.interactions_frame):
            frame.grid_forget()
        frame_to_show.grid(row=0, column=0, sticky="nswe")

    # Novo método para mostrar o dashboard
    def show_dashboard_frame(self):
        """Atualiza as estatísticas e exibe a tela do dashboard."""
